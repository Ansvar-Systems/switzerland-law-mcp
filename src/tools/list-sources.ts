  ...
  return {
    results: {
      sources: [
        {
          name: 'Fedlex',
          authority: 'Swiss Federal Chancellery (Bundeskanzlei)',
          url: 'https://www.fedlex.admin.ch',
          license: 'Open Government Data (OGD)',
          coverage:
            'All Swiss federal legislation in the Classified Compilation (SR/RS), ' +
            'including federal acts, ordinances, and the Federal Constitution',
